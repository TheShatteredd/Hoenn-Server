...
try {
	...
	global.profile = require('./src/stuff/profile.js').Utilities;
} catch (e) {
	console.log('Error loading profile.js: ' + e.stack);
}
try {
	global.money = require('./src/money/money.js').money();
} catch (e) {
	console.log('Error loading money.js: ' + e.stack);
}
var novabot = require('./src/chatbot/novabot.js');

var suppbot = require('./src/chatbot/suppbot.js');
var wisebot = require('./src/chatbot/wisebot.js');
var modbot = require('./src/chatbot/modbot.js');
